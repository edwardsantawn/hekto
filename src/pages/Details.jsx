...
export default function Details() {
  ...
  return (
    <div className="details-page flex flex-col justify-center items-center min-h-screen bg-white">
      {/* Main Product Section */}
      <div className="details-main flex items-start my-[100px] mx-[304px]">
        ...
        <div className="details-info flex flex-col w-[413px] justify-start mt-[40px] flex-1">
          ...
          <div className="details-pricing flex gap-4 items-center mb-6">
            <span className="details-price text-[#101750] leading-[20px] font-normal text-[16px]">{product.price}</span>
      ...
      <div className="details-tabs w-full flex justify-center bg-[#F8F8FD] py-16 mt-16">
        <div className="details-tabs-inner w-[1088px]">
          <div className="details-tabs-buttons flex gap-[72px] ">
            {/* Tab buttons only, no click logic */}
            <button className="details-tab-btn relative text-[#101750] font-bold text-[26px] leading-[32px]  transition-colors">
              Description
              <span className="details-tab-underline absolute left-1/2 -translate-x-1/2 bottom-0 block h-[2px] w-full bg-[#101750] rounded" />
            </button>
            <button className="details-tab-btn relative text-[#101750] font-bold text-[26px] leading-[32px]  transition-colors">
              Additional Info
            </button>
          ...
          <div className="details-tab-content pt-[48px]">
            <h3 className="details-desc-title text-[#101750] font-bold text-[22px] leading-[20px] mb-4">Varius tempor.</h3>
            <p className="details-desc-text text-[#8A8FB9] text-[16px] w-[1088px] h-[80px] font-normal leading-[20px]">
            ...
            <h4 className="details-desc-more text-[#101750] font-bold leading-[28px] text-[22px] mt-8 mb-4">More details</h4>
            <ul className="details-desc-list flex flex-col gap-4">
              {descriptionList.map((item, idx) => (
                <li key={idx} className="details-desc-listitem flex items-start gap-3 text-[#A9ACC6] text-[16px] leading-[24px]">
                  <img src={greytick} alt="" className="details-desc-tick mt-1" />
                  <span className='details-desc-listtext text-[#8A8FB9] font-normal text-[16px] leading-[20px]'>{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <section>
            ...
            <div className="details-related-list flex gap-8 w-full">
              {relatedProducts.map((p, i) => (
                <div
                  key={i}
                  className="details-related-card w-[304px] h-[368px] bg-white rounded-[12px] shadow-[0_8px_24px_rgba(0,0,0,0.05)]
                ...
                >
                  <div className="details-related-imgwrap relative mb-[24px] w-full flex justify-center">
                    {/* Icons */}
                    <span className="details-related-icons flex absolute gap-[8px] top-[8px] left-[8px] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <img src={p.img} alt={p.name} className="details-related-img rounded-[4px] mx-auto" />
                    {/* Button */}
                    <button
                      className="details-related-btn bg-[#0CC562] text-white text-[12px] leading-[14px] font-semibold absolute w-[101px] h-[36px] left-1/2 -translate-x-1/2 bottom-[5px] px-[16px] py-[11px] rounded-[6px] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    >
                      View Details
                    </button>
                  </div>
                  <h3 className="details-related-name text-[16px] text-[#FB2E86] font-bold leading-[20px] mb-[24px]">{p.name}</h3>
                  <span className="details-related-code text-[14px] text-[#8A8FB9] font-normal leading-[16px] mb-[8px]">{p.code}</span>
                  <span className="details-related-price text-[16px] text-[#101750] font-semibold leading-[20px]">{p.price}</span>
                </div>
              ))}
            </div>
          </section>
