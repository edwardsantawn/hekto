...
export default function Trending() {
  return (
    <section className="w-full bg-[#FFF] max-w-[1920px] mx-auto wrapper ">
      ...
      <div className="w-full max-w-[1360px] mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[32px]">
        {products.map((p, i) => (
          <article
            key={i}
            className="group bg-white rounded-[8px] flex flex-col items-center min-h-[340px] shadow-md
          ...
          >
            ...
            <img
              src={p.img}
              alt={p.name}
              className="mb-[32px] w-full max-w-[272px] h-[232px] object-contain flex-none"
            />
