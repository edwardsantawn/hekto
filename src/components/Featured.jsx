	...
	return (
        ...
        "
			>
				...
				<div
					className="
            grid grid-cols-1 sm:grid-cols-2 gap-[64px] sm:gap-6 carousel mt-[72px] overflow-visible
              ...
              "
						>
							<div className="relative mb-[24px] w-full flex justify-center items-center h-auto max-h-[472px]">
								{/* Hover icons (still fine on mobile, just sit there) */}
                  ...
                  "
							...
							<p className="text-[16px] price text-[#101750] font-bold leading-[20px]">
								{p.price}
							</p>
						</article>
					))}
				...
				<div className="flex mt-[60px] justify-center gap-[10px]">
					<label
						htmlFor="item-1"
						className="w-[16px] h-[4px] rounded-[10px] bg-[#FEBAD7] cursor-pointer"
					/>
					<label
						htmlFor="item-2"
						className="w-[16px] h-[4px] rounded-[10px] bg-[#FEBAD7] cursor-pointer"
